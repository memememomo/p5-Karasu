package Karasu::Plugin::SQLPager;
use strict;
use warnings;
use utf8;
...
=head1 NAME
    ...
    Karasu::Plugin::SQLPager - paginate with sql
...
This argument is optional. If you don't pass a table name, Karasu guess table name automatically.
